...
# This section is copied from ElegantOTA's platformio_upload.py
...
# ---- End of section copied from ElegantOTA's platformio_upload.py

            
try:
    env.GetProjectOption('custom_upload_url')
    env.Replace(UPLOADCMD=on_upload)
except:
    print("custom_upload_url not found. Not using elegantOTA upload")
